...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(230, 70, 321, 91))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        ...
        self.pushButton.setGeometry(QtCore.QRect(200, 190, 221, 61))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "请点击下面按钮！"))
